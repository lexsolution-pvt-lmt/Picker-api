                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="http://127.0.0.1:8000/api/categories" method="post">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" name="name">Name
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" name="image">Image <span
                                                            class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <input type="text" class="form-control" name="image" placeholder="Choose Your Image.">
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" name="slug" >Slug
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-4 col-form-label" name="description" >Description
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
